...
<div class="middle_land_inner">
<div class="nav_bar_land_inner">
...
<?php
	...
	$hDB->Query("SELECT * FROM tbl_land_project_".$project." WHERE land_pro_".$prefix."_id = '".$id."'");
	$obj = $hDB->Arrays();

?>
<div class="noboudoy_purbachal_city"><?php print $obj[1] ?></div>

<div id="terms"><a href="land_project_inner.php?<?php print 'project='.$project.'&opt=terms&id='.$id ?>">Terms & Conditions</a></div>
<div class="white_bar_bg">
<div id="application"><a href="land_project_inner.php?<?php print 'project='.$project.'&opt=application&id='.$id ?>">Application Form</a></div></div>
<div id="layout"><a href="land_project_inner.php?<?php print 'project='.$project.'&opt=layout&id='.$id ?>">Layout Plan</a></div>
<div class="white_bar_bg">
<div id="feature"><a href="land_project_inner.php?<?php print 'project='.$project.'&opt=feature&id='.$id ?>">Features</a></div></div>
<div id="price"><a href="land_project_inner.php?<?php print 'project='.$project.'&opt=pricelist&id='.$id ?>">Pricelist</a></h20>
<div class="white_bar_bg">
<div id="location"><a href="land_project_inner.php?<?php print 'project='.$project.'&opt=location&id='.$id ?>">Location Map</a></div></div>
...
<div style="font-family:Arial, Helvetica, sans-serif; font-size:13px; margin:5px 5px 5px 5px; height:410px; overflow:auto; text-align:justify; line-height:20px; padding:0 10px 0 5px">
	<?php
		...
		{
	?>
            <iframe src="http://docs.google.com/viewer?url=http%3A%2F%2Fwww.noboudoy.com%2Fproject%2Fland%2F<?php print str_replace(' ','%20',$obj[1]) ?>%2Fapplication.pdf&embedded=true" width="550" height="406" style="border: none;"></iframe>
            <!--<iframe src="http://docs.google.com/gview?url=http://infolab.stanford.edu/pub/papers/google.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
            <!--<iframe src="http://docs.google.com/viewer?url=http%3A%2F%2Fwww.noboudoy.com%2Fproject%2FNoboudoy%20Handover%2Fapplication.pdf&embedded=true" width="600" height="780" style="border: none;"></iframe>-->
    		...
    		<table border="0" style="margin:0px">
            	<tr>
                	<td width="545" height="400" align="center" valign="middle">
                        <a class="colorbox" href="project/land/<?php print $obj[1] ?>/pricelist.jpg" style="margin:0 auto; width:545px">
                            <img src="project/land/<?php print $obj[1] ?>/pricelist.jpg" style="max-height:400px; max-width:545px" />
                        </a>
                 	</td>
              	</tr>
           	</table>
	...
	?>
    		<table border="0" style="margin:0px">
            	<tr>
                	<td width="545" height="400" align="center" valign="middle">
                        <a class="colorbox" href="project/land/<?php print $obj[1] ?>/location.jpg" style="margin:0 auto; width:545px"> 
                            <img src="project/land/<?php print $obj[1] ?>/location.jpg" style="max-height:400px; max-width:545px" />
                        </a> 
                   	</td>
              	</tr>
           	</table>
	...
	?>
    	<div style="margin:3px 0 0 5px">
            <OBJECT CLASSID="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" CODEBASE="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" WIDTH="540" HEIGHT="400" ID="theMovie">
                		<PARAM NAME="FlashVars" VALUE="zoomifyImagePath=project/land/<?php print $obj[1] ?>/layout_img&zoomifyNavigatorVisible=false=true">
                		<PARAM NAME="BGCOLOR" VALUE="#000000">
                		<PARAM NAME="MENU" VALUE="FALSE">
				<PARAM NAME="SRC" VALUE="project/land/<?php print $obj[1] ?>/layout_img/zoomifyViewer.swf">
               			<EMBED FlashVars="zoomifyImagePath=project/land/<?php print $obj[1] ?>/layout_img&zoomifyNavigatorVisible=false=true" SRC="project/land/<?php print $obj[1] ?>/layout_img/zoomifyViewer.swf" BGCOLOR="#000000" MENU="false" PLUGINSPAGE="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"  WIDTH="540" HEIGHT="400" NAME="theMovie"></EMBED>
         	</OBJECT>
    	</div>
	<?php
		}
	...
	?>
    		<table border="0" style="margin:0px">
            	<tr>
                	<td width="545" height="400" align="center" valign="middle">
    					<img src="project/land/<?php print $obj[1] ?>/thumbnail.jpg" style="max-height:400px; max-width:545px" />
                    </td>
              	</tr>
           	</table>
    <?php
