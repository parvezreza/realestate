...
<div class="nav_bar_apartment_project">
  <div class="middle_content_apartment_project">
  ...
  <!--[if !IE]>-->
  <object type="application/x-shockwave-flash" data="flash/appartment.swf" width="690" height="224">
    <!--<![endif]-->
    <param name="quality" value="high" />
    <param name="wmode" value="opaque" />
    <param name="swfversion" value="6.0.65.0" />
  ...
  <!--<![endif]-->
   ...
   <div class="some_text_here">Apartment Project</div>
<div class="paragraph">
...
<a href="apartment_project.php?project=handed over" ><img style="border:none" src="images/apartment-handed over.png" /></a>
</div>

<div class="Ongoing_projects_img">
<a href="apartment_project.php?project=ongoing"><img style="border:none" src="images/apartment-ongoing.png" /></a>
</div>

<div class="Upcoming_projects_img">
<a href="apartment_project.php?project=upcoming"><img style="border:none" src="images/apartment-upcoming.png" /></a>
</div>

<div class="Handed_over_projects_text">
<a href="apartment_project.php?project=handed over">Handed Over Projects</a>
</div>

<div class="Ongoing_projects_text">
<a href="apartment_project.php?project=ongoing">Ongoing Projects</a>
</div>
    
<div class="Upcoming_projects_text">
<a href="apartment_project.php?project=upcoming">Upcoming Projects</a>
</div>

<div class="black_box_bg">
<div class="black_box_header">
<h4>
	Apartment Project <?php if($_GET['project']) print '- '.ucwords($_GET['project']) ?>
</h4>
...
<div class="scroll">
	...
	{
		$hDB->Query("SELECT apart_pro_over_id, apart_pro_over_name, apart_pro_over_feature FROM tbl_apartment_project_handover");
    ...
    ?>
        <div class="black_box_border">
            <h1>
                <?php print $obj->apart_pro_over_name ?>
            </h1>
            <h5 id="h5">
                <?php print substr(strip_tags($obj->apart_pro_over_feature),0,130)."..." ?>
            </h5>
            <div class="read_more">
                <h3>
                    <a href="apartment_inner.php?project=handover&id=<?php print $obj->apart_pro_over_id ?>">Read more</a>
                </h3>
            </div>
        </div>
        <div class="black_box_border_right_img4">
            <img src="project/apartment/<?php print $obj->apart_pro_over_name ?>/thumb_thumbnail.jpg" />
        </div>
	<?php
		}
	}
	...
	{
		// For ongoing
        $hDB->Query("SELECT apart_pro_on_id, apart_pro_on_name, apart_pro_on_feature FROM tbl_apartment_project_ongoing");
        while($obj = $hDB->Fetch())
        {
    ?>
        <div class="black_box_border">
            <h1>
                <?php print $obj->apart_pro_on_name ?>
            </h1>
            <h5 id="h5">
                <?php print substr(strip_tags($obj->apart_pro_on_feature),0,130)."..." ?>
            </h5>
            <div class="read_more">
                <h3>
                    <a href="apartment_inner.php?project=ongoing&id=<?php print $obj->apart_pro_on_id ?>">Read more</a>
                </h3>
            </div>
        </div>
        <div class="black_box_border_right_img4">
            <img src="project/apartment/<?php print $obj->apart_pro_on_name ?>/thumb_thumbnail.jpg" />
        </div>
	<?php
		}
	}
	...
	{
		//For Upcoming
        $hDB->Query("SELECT apart_pro_up_id, apart_pro_up_name, apart_pro_up_feature FROM tbl_apartment_project_upcoming");
        while($obj = $hDB->Fetch())
        {
    ?>
        <div class="black_box_border">
            <h1>
                <?php print $obj->apart_pro_up_name ?>
            </h1>
            <h5 id="h5">
                <?php print substr(strip_tags($obj->apart_pro_up_feature),0,130)."..." ?>
            </h5>
            <div class="read_more">
                <h3>
                    <a href="apartment_inner.php?project=upcoming&id=<?php print $obj->apart_pro_up_id ?>">Read more</a>
                </h3>
            </div>
        </div>
        <div class="black_box_border_right_img4">
            <img src="project/apartment/<?php print $obj->apart_pro_up_name ?>/thumb_thumbnail.jpg" />
        </div>
	<?php
		}
	}
